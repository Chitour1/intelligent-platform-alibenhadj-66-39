...
الكتاب يُعد مرافعة شرعية وسياسية، تستحضر النصوص والمقاصد، والتجارب، والتحذيرات الواقعية، من أجل تثبيت مفهوم الوحدة، وإدانة كل مشاريع التشظي التي تمزق الأمة من الداخل، سواء بجهل أبنائها أو بمكر أعدائها.`
  },
  {
    ...
    author: "أبو عبد الفتاح علي بن حاج",
    cover: "/lovable-uploads/6a606e6a-0e74-4071-9c9c-b668772dd707.png",
    ...
    pages: "١٠",
    description: "رسالة فكرية قصيرة تعد من الوثائق التأسيسية التي تعبر عن فكر الجبهة الإسلامية للإنقاذ في بداياتها، لاسيما في مجال التأصيل الشرعي لقضية 'التغيير' في الواقع الإسلامي.",
