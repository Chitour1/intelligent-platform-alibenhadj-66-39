...
import { ArrowLeft, ArrowRight, Clock, ChevronRight, ChevronDown } from 'lucide-react';
...
const FridayMeetingsVideo = () => {
  ...
  // Video timeline sections for the March 22, 2025 video
  const videoTimeline = [
    { 
      id: 1, 
      startTime: "00:00:00", 
  ...
  // Only show the timeline for the March 22, 2025 video
  const showTimeline = currentVideo === "XS7jF85h9TY";
    ...
    <div className="section-container">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          {/* Timeline section - only show for specific video */}
          {showTimeline && (
