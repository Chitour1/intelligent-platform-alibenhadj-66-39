...
import { ArrowLeft, Calendar, Clock, Share2, BookOpen, Video, Headphones, ChevronDown, ChevronRight } from 'lucide-react';
...
const videoTimelineMarch22 = [
  ...
  { 
    ...
    startTime: "00:38:50", 
    endTime: "00:41:05", 
    title: "لماذا لم يعد ��لقرآن يحرك المسلمين؟",
  ...
  { 
    ...
    description: "الدعوة للتم��يز بين نقد الأفعال وسب الصحابة"
  },
  { 
    id: 27, 
    startTime: "01:24:23", 
...
const videoTimelineMarch23 = [
  ...
  { 
    ...
    description: "التفريق بين الصمت المحمود والكلام الواجب، وأهمية اجتناب اللغو والجدا��"
  },
  { 
    id: 5, 
    startTime: "06:41", 
  ...
  { 
    ...
    description: "تقديم دعوة للتوثيق ��لشخصي للانتهاكات، وانتقاد سياسات الصمت والتطبيع"
  }
];
          ...
          <div className="mt-12">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              <Button 
                variant="outline" 
                size="sm" 
                className="flex items-center gap-2 border-gold text-gold hover:bg-gold/10"
